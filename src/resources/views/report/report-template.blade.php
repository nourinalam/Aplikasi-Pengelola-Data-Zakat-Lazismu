...
<html lang="en">
  ...
  @endphp
    <header class="clearfix">
      <div id="logo">
        <img src="public/logolazismu.png">
      </div>
      <div id="company">
        <h2 class="name">{{ config('app.name', 'Laravel') }}</h2>
        <div>Jl. Gedongkuning No.152, RT.41, Rejowinangun, Kotagede, Yogyakarta, DIY 55171</div>
        <div>0821-3833-9339</div>
        <div><a href="mailto:lazismudiy@gmail.com">lazismudiy@gmail.com</a></div>
      </div>
      </div>
    </header>
    <main>
